...
function create_post_type_testimonial() {
	...
	register_post_type('testimonial', 
		array(
			'labels' => array(
				'name' => esc_html__( 'Testimonials', 'chauffeur' ),
                'singular_name' => esc_html__( 'Testimonial', 'chauffeur' ),
				'add_new' => esc_html__('Add Testimonial', 'chauffeur' ),
				'add_new_item' => esc_html__('Add New Testimonial' , 'chauffeur' )
			),
		'public' => true,
		'menu_position' => 5,
		'menu_icon' => 'dashicons-admin-post',
		'rewrite' => array(
			'slug' => esc_html__('testimonials','chauffeur')
		), 
...
$testimonial_meta_fields = array(  
    array(  
		'label'=> esc_html__('Passenger Name','chauffeur'),  
		'desc'  => '',  
		'id'    => $prefix.'testimonial_name',  
		'type'  => 'text'
	),	
	array(  
        'label'=> esc_html__('Other Details','chauffeur'),  
        'desc'  => '',  
